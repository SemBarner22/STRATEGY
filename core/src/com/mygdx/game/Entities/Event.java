...
import com.mygdx.game.Entities.Modificator;
...
public class Event {
    ...
    // Сюда видимо стоит положить разные штуки типо текста, надпи, а потом будет выподать ивент пропорционально его частоте.
